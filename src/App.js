  ...
  return (
    <div className="h-100">
      ...
      <div className="d-flex flex-row justify-content-around align-items-center h-100">
        <div>
          <small className="d-inline-flex mb-3 px-2 py-1 fw-semibold text-success bg-success bg-opacity-10 border border-success border-opacity-10 rounded-2">Recent Voters</small>
        ...
        <CardGroup>
          ...
          <Card border="light" style={{ width: '18rem', marginLeft: "40px" }}>
            ...
            <Card.Body>
              ...
              <Button style={{width:"80px"}} disabled={loading} onClick={onVoteCandidateB} variant="primary">Vote</Button>
            </Card.Body>
          </Card>
        </CardGroup>
